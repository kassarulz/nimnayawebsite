...
<div class="homecontainer">
	<br>
	<br>
	<h2><i>View reports</i></h2>
	<div class="row">
		<div class="col-md-12 col-lg-12">
	
		@include('inc.messages')
	 <div class="col-md-12 col-md-offset-1">
	<a href="AdminReport1"  class=" btn btn-success"><h4>view report1</h4></a><br><br>

	<a href="AdminReport2"  class=" btn btn-success"><h4>view report2</h4></a><br><br>

	<a href="AdminReport3"  class=" btn btn-success"><h4>view report3</h4></a><br><br>
		</div>

...
class TeacherReport1 extends Controller  
{
 ...
 public function reportPdfT1()
{
   ...
   return $pdf->download('TeacherReport1.pdf');
}

  public function reportT1()
    {//$users = DB::table('users')->get();
    //$subjects = DB::table('subjects')->get();
       // $users = DB::table('users')->get();
		...
		//$subject = Subject::all();
       // return $subject;
       return view('TeacherReport1', ['users' => $users]);
	}
}
